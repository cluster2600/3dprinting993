...
Une fiche JSON représente une source potentielle : catalogue officiel, manuel,
mesure, modèle 3D, photographie ou jeu de données. Elle enregistre séparément
l’accès technique, la méthode de lecture et les droits de réutilisation.
